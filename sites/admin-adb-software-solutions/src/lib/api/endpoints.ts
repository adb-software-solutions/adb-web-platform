...
export const PublicAPI = {
    portfolio: {
        list: () => `${API_BASE_URL}/public/portfolio/`,
        get: (slug: string) => `${API_BASE_URL}/public/portfolio/${slug}/`,
    },
    testimonials: {
        list: () => `${API_BASE_URL}/public/testimonials/`,
    },
    blog: {
        posts: {
            list: () => `${API_BASE_URL}/public/blog/posts/`,
            get: (slug: string) => `${API_BASE_URL}/public/blog/posts/${slug}/`,
        },
        categories: {
            list: () => `${API_BASE_URL}/public/blog/categories/`,
        },
        tags: {
            list: () => `${API_BASE_URL}/public/blog/tags/`,
        },
    },
    faqs: {
        list: () => `${API_BASE_URL}/public/faqs/`,
        categories: {
            list: () => `${API_BASE_URL}/public/faqs/categories/`,
        },
    },
    contact: {
        submit: () => `${API_BASE_URL}/website/contact/`,
    },
};
