...
export function TicketTimerControl({
    ticketId,
    onTimeChanged,
}: {
    ticketId: number;
    ...
    const runningForTicket = timer?.ticket_id === ticketId;
        ...
        <Card className="p-4">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    ...
                    {loading ? (
                    ...
                    ) : runningForTicket && timer ? (
                        <div className="mt-1 flex items-baseline gap-3">
                            <span className="font-mono text-2xl font-semibold tabular-nums text-white">
                                {formatElapsed(elapsed)}
                            </span>
                            <span className="text-sm text-emerald-400">Tracking this ticket</span>
                        </div>
                    ) : timer ? (
                        ...
                        <div className="mt-1 text-sm text-slate-500">
                            Start tracking work against this conversation without leaving the ticket.
                        </div>
                    )}
