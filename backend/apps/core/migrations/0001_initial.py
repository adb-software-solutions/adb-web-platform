...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                "ordering": ["-created_at"],
                "permissions": [("view_sensitive_audit_metadata", "Can view sensitive audit metadata")],
            },
        ),
