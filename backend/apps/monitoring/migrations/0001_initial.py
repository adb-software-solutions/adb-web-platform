    ...
    operations = [
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("tcp", "TCP port"),
                            ("http", "HTTP/HTTPS"),
                            ("content", "Expected/forbidden content"),
                            ("tls", "TLS certificate"),
                            ("dns", "DNS record"),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("resource", "name"), name="unique_monitor_check_name_per_resource"
            ),
        ),
        migrations.AddIndex(
            model_name="monitorcheck",
            index=models.Index(fields=["enabled", "next_run_at"], name="monitor_due_check_idx"),
        ),
        migrations.AddIndex(
            model_name="monitorcheck",
            index=models.Index(fields=["resource", "status"], name="monitor_resource_status_idx"),
        ),
        migrations.AddIndex(
            model_name="monitorresult",
            index=models.Index(
                fields=["monitor_check", "-started_at"], name="monitor_result_history_idx"
            ),
        ),
        migrations.AddConstraint(
        ...
        migrations.AddIndex(
            model_name="monitorincident",
            index=models.Index(fields=["status", "-opened_at"], name="monitor_incident_idx"),
        ),
    ]
